...
const Index = () => {
  ...
  return (
    <Layout>
      ...
      {/* Remeselnici Section - Always shown now */}
          ...
          <div className="grid grid-cols-1 md:grid-cols-12 gap-4">
            <div className="md:col-span-5 relative group">
              ...
              <Input 
                ...
                className={`pl-10 transition-all duration-300 hover:shadow-md focus:shadow-lg focus:scale-[1.02] ${isSearchFocused ? 'border-primary/30' : ''}`} 
              />
            </div>
            ...
            <div className="md:col-span-3 relative group">
              ...
              <Input 
                ...
                className={`pl-10 transition-all duration-300 hover:shadow-md focus:shadow-lg focus:scale-[1.02] ${isLocationFocused ? 'border-primary/30' : ''}`} 
              />
            </div>
