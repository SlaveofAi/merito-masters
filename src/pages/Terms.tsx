        ...
        <div className="prose max-w-none">
          <section className="mb-8">
            ...
            <p className="text-muted-foreground">
              Tieto podmienky používania upravujú práva a povinnosti medzi prevádzkovateľom webovej stránky Majstri.com 
              (ďalej len "Platforma") a jej užívateľmi. Prevádzkovateľom Platformy je fyzická osoba, ktorá je dostupná 
          ...
          <section className="mb-8">
            <h2 className="text-xl font-semibold mb-4">2. Registrácia a vekové obmedzenie</h2>
            <p className="text-muted-foreground">
          ...
          <section className="mb-8">
            ...
            <p className="text-muted-foreground">
              ...
              Po rezervácii sa v chate zobrazuje notifikácia, ktorú majster potvrdí. Po potvrdení sa rezervácia 
              objaví v sekcii "Zákazky".
            </p>
          </section>
          ...
          <section className="mb-8">
            ...
            <p className="text-muted-foreground">
              ...
              Nenesie zodpovednosť za kvalitu, rozsah alebo úspešnosť vykonaných prác. Používateľ je plne 
              zodpovedný za svoje konanie.
            </p>
          </section>
          ...
          <section className="mb-8">
            ...
            <p className="text-muted-foreground">
              V súčasnosti sa platby realizujú mimo Platformu. V budúcnosti môže byť zavedená funkcia spracovania 
              platieb cez Platformu, o čom budú používatelia vopred informovaní.
            </p>
          </section>
          ...
          <section className="mb-8">
            ...
            <p className="text-muted-foreground">
              Prevádzkovateľ si vyhradzuje právo zablokovať alebo zrušiť účet používateľa, ktorý poruší tieto 
              podmienky alebo zneužije funkcie Platformy.
            </p>
          </section>
          ...
          <section className="mb-8">
            ...
            <p className="text-muted-foreground">
              Platforma uchováva nasledovné osobné údaje: e-mail, telefónne číslo a lokalitu. Tieto údaje sú 
              spracovávané v súlade so Zákonom o ochrane osobných údajov a budú doplnené v samostatnej Politike 
          ...
          <section className="mb-8">
            ...
            <p className="text-muted-foreground">
              Platforma plánuje používanie analytických nástrojov a cookies v budúcnosti. Používatelia budú mať 
              možnosť spravovať svoje nastavenia cookies.
            </p>
          </section>
          ...
          <section className="mb-8">
            ...
            <p className="text-muted-foreground">
              Tieto podmienky nadobúdajú účinnosť dňom ich zverejnenia na Platforme. Prevádzkovateľ si vyhradzuje 
              právo tieto podmienky kedykoľvek zmeniť. O významných zmenách budú používatelia informovaní.
            </p>
          </section>
        </div>
      </div>
